...
export default function Socials() {
  return (
    <section className="max-md:mt-10 relative md:min-h-screen w-full flex flex-col gap-3 md:-mt-9 z-[9999]">
      <p className="md:ml-16 container text-white font-sf-pro-display md:text-base font-bold text-base uppercase">
        Socials
      </p>

      <div className="flex-1 flex flex-col md:min-h-screen">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 md:min-h-screen">
